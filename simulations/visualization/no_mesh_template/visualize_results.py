...
# all converged in 16 iterations except for 250 which did 15, so this is likely artificial convergence
# next simulation will not use SS detection, but will keep turning off the mesh template